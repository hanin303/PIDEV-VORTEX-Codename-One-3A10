...
public class AjoutItineraireForm extends BaseForm{
    Form current;
    public static final String CONSTRAINT_ALPHA = "^[a-zA-Z]+$";
    private String lastValidInput ;
    
   
    public AjoutItineraireForm(User u,Form prev,Resources res ){
...
btnHome.addActionListener((e) -> {
    ItineraireHome home = new ItineraireHome (u,prev);
    home.show();
});
