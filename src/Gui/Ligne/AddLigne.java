 ...
 * @author Asus
 */
public class AddLigne extends Form {
       Form current;
    //setTitle("List Ligne");
       
    public AddLigne(User u, Form prev,Resources res ){
    ...
    btnAjouter.addActionListener((e)->{
        try{
            ...
            Dialog.show("Verifier les données","","annuler","verifier");}
            else{
    ...
    LigneHome home = new LigneHome(u,prev);
    home.show();
});
}
