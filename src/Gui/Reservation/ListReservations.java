...
public class ListReservations extends Form{
    ...
    if (searchText.isEmpty()) {
        reservations = ServiceReservation.getInstance().getAllReservations();
    } else {
        reservations = ServiceReservation.getInstance().searchReservations(searchText);
    }
    removeAll(); //
}
...
private void clearSearch() {
    ...
    public ListReservations(User u,Form previous) {
   ...
   btnHome.addActionListener((e) -> {
    ReservationHome home = new ReservationHome(u,previous);
    home.show();
});
  
    // Ajouter le champ de recherche et les boutons
    ...
    searchContainer.add(BorderLayout.EAST, searchButton);
    searchContainer.add(BorderLayout.WEST, clearButton);
    addComponent(searchContainer);
        ...
        card.add(BorderLayout.CENTER, BoxLayout.encloseY(clientLabel, heureDepartLabel, heureArriveLabel,
    ...
    submitButton.addActionListener(submitEvent -> {
        ...
        String Date_reservation = Date_reservationField.getText();
       ...
       // Call the service function to update the station
        ...
        Dialog.show("Success", "Reservation updated successfully", "OK", null);
            ListReservations refresh = new ListReservations(u,previous);
     refresh.show();
    });
