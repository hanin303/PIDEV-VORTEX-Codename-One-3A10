...
public class AddReservationForm extends Form{
     ...
     public AddReservationForm(User u, Form prev,Resources res) {
    ...
    //btnAjouter.setIcon(FontImage.createMaterial(FontImage.MATERIAL_ADD, btnAjouter.getUnselectedStyle()));
    btnAjouter.setIcon(FontImage.createMaterial(FontImage.MATERIAL_ADD_BOX, btnAjouter.getUnselectedStyle()));
    ...
    btnAjouter.addActionListener((e)->{
        ...
        try{
            ...
            Dialog.show("Reservation ajoutée avec succès", "", "OK", null);
            }
        }catch(Exception ex){
            ex.printStackTrace();}
    });
        ...
        ReservationHome home = new  ReservationHome(u,prev);
    home.show();
});
}
