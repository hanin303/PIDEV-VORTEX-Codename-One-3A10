...
public class ModifierReclamation extends BaseForm {
    ...
    public ModifierReclamation(User u, Form prev, Reclamation reclamation) {
        setTitle("Modifier la reclamation");
        ...
        sujetField.setUnselectedStyle(textFieldStyle);
         ...
         text_recField.setText(reclamation.getMessage_rec());
         sujetField.setText(reclamation.getObjet());
        ...
        modifierButton.addActionListener(e -> {
           ...
           // String text_rec = text_recField.getText();
            ...
            new Reclamationlist(u,prev).showBack();
        });
        ...
        retourButton.addActionListener(e -> new Reclamationlist(u,prev).showBack());
