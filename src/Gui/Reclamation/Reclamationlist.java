...
public class Reclamationlist extends BaseForm {
     ...
     public Reclamationlist(User u,Form prev) {
        ...
        Container container1 = new Container(new FlowLayout(Component.LEFT));
        container1.add(back);
        addComponent(container1);
       
        
        
        AjouterReclamation al = new AjouterReclamation(u,prev);
...
deleteButton.addActionListener(e -> {
    ...
    if (confirmed) {
        ...
        new Reclamationlist(u,prev).show();
    }
});


/////////////////////////////////////////////////////////////////////////////////////////////
   ModifierReclamation ml = new ModifierReclamation(u,prev,reclamation);
